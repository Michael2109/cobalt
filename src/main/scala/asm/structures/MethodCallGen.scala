...
/**
  ...
  */
class MethodCallGen(var superBlockInit: Block, var nameInit: String, var typeInit: String, var paramsInit: Array[Parameter]) extends Block(superBlockInit, false, false) {
