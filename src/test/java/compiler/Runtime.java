...
import compiler.parser.structures.MethodCallParser;
import compiler.parser.structures.ObjectMethodCallParser;
import compiler.parser.structures.ObjectParser;
    ...
    public Runtime(File sourceFile, File outputFile) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (noParse) throw new ParseException("Line: " + lineNumber);
