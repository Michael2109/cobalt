...
testConstructorParser = do
    ...
    let testEmptyParams = testParseSuccess codeEmptyParams (MethodDef (Method {methodName = Name "this", methodAnns = [], methodParams = [], methodModifiers = [], methodReturnType = Just Init, methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser

    let codeMultipleParams = "let this (a: Int, b: Int) = _"
    let testMultipleParams = testParseSuccess codeMultipleParams (MethodDef (Method {methodName = Name "this", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [], methodReturnType = Just Init, methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser

    let codeDoBlock = unlines [ "let this () = do"
                              , "    i"
                              , "    j"
                              ]
    let testDoBlock = testParseSuccess codeDoBlock (MethodDef (Method {methodName = Name "this", methodAnns = [], methodParams = [], methodModifiers = [], methodReturnType = Just Init, methodBody = StmtAssignment (BlockStmt [ExprAsStmt (Identifier (Name "i")),ExprAsStmt (Identifier (Name "j"))])})) methodDefParser
    ...
    let testNestedMethod = testParseSuccess codeNestedMethod (MethodDef (Method {methodName = Name "this", methodAnns = [], methodParams = [], methodModifiers = [], methodReturnType = Just Init, methodBody = StmtAssignment (BlockStmt [MethodDef (Method {methodName = Name "innerMethod", methodAnns = [], methodParams = [], methodModifiers = [], methodReturnType = Just $ TypeRef (RefLocal (Name "Int")), methodBody = StmtAssignment (BlockStmt [ExprAsStmt (Identifier (Name "i"))])}),ExprAsStmt (Identifier (Name "j"))])})) methodDefParser

    let codeModifierPublic = "public let this (a: Int, b: Int) = _"
    let testModifierPublic = testParseSuccess codeModifierPublic (MethodDef (Method {methodName = Name "this", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Public], methodReturnType = Just Init, methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser
