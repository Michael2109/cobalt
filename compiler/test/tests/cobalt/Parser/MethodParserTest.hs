...
testMethodParser = do
    ...
    let testEmptyParamsStmt = testParseSuccess codeEmptyParams (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [], methodModifiers = [], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) statementParser
    ...
    let testDoBlockStmt = testParseSuccess codeDoBlock (MethodDef (Method {methodName = Name "outerMethod", methodAnns = [], methodParams = [], methodModifiers = [], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = StmtAssignment (BlockStmt [ExprAsStmt (Identifier (Name "i")),ExprAsStmt (Identifier (Name "j"))])})) statementParser
    ...
    let testModifierFinal = testParseSuccess codeModifierFinal (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Final], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser
    let testModifierFinalStmt = testParseSuccess codeModifierFinal (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Final], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) statementParser

    let codeModifierAbstract = "abstract let exampleMethod (a: Int, b: Int): Int = _"
    let testModifierAbstract = testParseSuccess codeModifierAbstract (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Abstract], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser
    ...
    let testModifierPublicStmt = testParseSuccess codeModifierPublic (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Public], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) statementParser

    let codeModifierProtected = "protected let exampleMethod (a: Int, b: Int): Int = _"
    let testModifierProtected = testParseSuccess codeModifierProtected (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Protected], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser
    ...
    let testModifierLocal = testParseSuccess codeModifierLocal (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [PackageLocal], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser
    let testModifierLocalStmt = testParseSuccess codeModifierLocal (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [PackageLocal], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) statementParser

    let codeModifierMultiple = "final abstract public protected local let exampleMethod (a: Int, b: Int): Int = _"
    let testModifierMultiple = testParseSuccess codeModifierMultiple (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Final, Abstract, Public, Protected, PackageLocal], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) methodDefParser
    let testModifierMultipleStmt = testParseSuccess codeModifierMultiple (MethodDef (Method {methodName = Name "exampleMethod", methodAnns = [], methodParams = [Field {fieldName = Name "a", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing},Field {fieldName = Name "b", fieldType = Just (TypeRef (RefLocal (Name "Int"))), fieldInit = Nothing}], methodModifiers = [Final, Abstract, Public, Protected, PackageLocal], methodReturnType = TypeRef (RefLocal (Name "Int")), methodBody = ExprAssignment (Identifier (Name "_"))})) statementParser
