...
package cobalt.ast.constants.string_constant
...
/**
  ...
  * @param value
  */
class StringConstantBlock(var superBlockInit: Block, value: String) extends ConstantBlock(superBlockInit, false, true) {

  override val getName: String = ""

  override val getValue: String = value

  override val getType: String = "String"
