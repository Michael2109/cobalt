...
testModifierBlockParserPrivate = do
    ...
    TestCase $ assertEqual code
        (ModifierBlock [GlobalVar "private" True True (Type (Identifier "int")) (Identifier "x") [IntConst 5],GlobalVar "private" True True (Type (Identifier "int")) (Identifier "y") [IntConst 10]])
...
testModifierBlockParserProtected = do
    ...
    TestCase $ assertEqual code
        (ModifierBlock [GlobalVar "protected" True True (Type (Identifier "int")) (Identifier "x") [IntConst 5],GlobalVar "protected" True True (Type (Identifier "int")) (Identifier "y") [IntConst 10]])
        (case (parse (modifierBlockParser True) "" code) of
             Left  _ -> Error
             Right x -> x)
...
testModifierBlockParserPublic = do
    ...
    TestCase $ assertEqual code
        (ModifierBlock [GlobalVar "public" True True (Type (Identifier "int")) (Identifier "x") [IntConst 5],GlobalVar "public" True True (Type (Identifier "int")) (Identifier "y") [IntConst 10]])
        (case (parse (modifierBlockParser True) "" code) of
             Left  _ -> Error
             Right x -> x)
