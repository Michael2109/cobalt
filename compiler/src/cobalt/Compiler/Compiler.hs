...
compileAST moduleName m symbolTable = encodeClass (generate [] (pack (intercalate "/"(extractNameSpaceValue (extractModuleHeaderNameSpace (extractModuleHeader m))) ++ "/" ++ moduleName)) (genCode $ moduleToModuleIR m))
