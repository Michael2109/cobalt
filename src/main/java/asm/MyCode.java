...
mv.visitInsn(DUP);
mv.visitIntInsn(ILOAD, 64);mv.visitIntInsn(ILOAD, 65);mv.visitMethodInsn(INVOKESPECIAL, "asm/MyCode", "<init>", "(II)V", false);
...
mv.visitIntInsn(ILOAD, 68);mv.visitMethodInsn(INVOKEVIRTUAL, "asm/MyCode", "method1", "(I)V", false);
